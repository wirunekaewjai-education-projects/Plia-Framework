...
public class Lighting extends BaseApplication
{
	...
	public Lighting()
	{
		...
		_3DLayer.addChild(camera, geosphere, blackBox, l1, l2, l3, redPoint, greenPoint, bluePoint, movingLight, movingLightPoint);
	}
